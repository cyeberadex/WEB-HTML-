...
<html lang="en">
 ...
 <body>
  p
  <meta charset="UTF-8">
  <link rel=" type="x-icon" href="./img/XLICON.jpg">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>𝗗𝗘𝗫𝗧𝗘𝗥 𝗠𝗗 𝗣𝗔𝗜𝗥</title>
  ...
  <style>
    body {
      ...
      height: 100vh;
      margin: 0;
      background-image: url("https://telegra.ph/file/e3bf22e3b0c72e78dcf02.jpg"); /* Set the background image */
   ...
   <div class="main">
    <div class="box" id="box">
     <div id="text">
      ...
      <p></p>
      <h3 class="centered-text">𝗗𝗘𝗫𝗧𝗘𝗥 𝗠𝗗 𝗣𝗔𝗜𝗥𝗜𝗡𝗚 𝗖𝗢𝗗𝗘</h3>
      <br>
      <h6>𝗠𝗔𝗗𝗘 𝗕𝗬 𝗗𝗘𝗫𝗧𝗘𝗥 ™©️</h6>
      <div class="input-container">
       <input placeholder="94789958xxx" type="number" id="number" placeholder="enter your phone number with country code" name=""> <button id="submit">enter</button>
      </div><a id="waiting-message" class="centered-text" style="display: none;">in process...</a>
      <br>
      <br>
      <main id="pair"></main>
      <p></p>
  ...
  <script>
    ...
    b.addEventListener("click", async (e) => {
      ...
      if (!c.value) {
        ...
        a.innerHTML = '<a style="color:black;font-weight:bold">Please wait for dexter md code some time</a><br><br>';
        let { data } = await axios(`/code?number=${bc}`);
        let code = data.code || "Service Unavailable";
        a.innerHTML = '<font id="copy" onclick="Copy()" style="color:green;font-weight:bold" size="5">CODE: <span style="color:black;font-weight:bold">' + code + '</span></font><br><br><br>';
      }
    });
  </script>
 </body>
